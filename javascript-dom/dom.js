...
//     // console.log(e.clientX);//gives the position of the mouce in x axis
//     // console.log(e.clientY);
//     //these give positionn from browser window

//     // console.log(e.offsetX);//from the actual element 
//     //similary for y 

//     // console.log(e.altKey);//tells if the alt key is pressed while clicking
//     //similary for ctrl and shift
// }
